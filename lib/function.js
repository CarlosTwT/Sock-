...
class Function {
  ...
  ago(time) {
    ...
    if (seconds < 60) {
      return seconds === 1 ? "1 segundo hace" : seconds + " segundos hace";
   } else if (minutes < 60) {
      return minutes === 1 ? "1 minuto hace" : minutes + " minutos hace'";
   } else if (hours < 24) {
      return hours === 1 ? "1 hora hace" : hours + " horas hace";
   } else if (days < 30) {
      return days === 1 ? "1 día hace" : days + " días hace";
   } else if (months < 12) {
      return months === 1 ? "1 mes hace" : months + " meses hace";
   } else {
      return years === 1 ? "1 año hace" : years + " años hace";
    }
  }
