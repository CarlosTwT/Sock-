...
m.sendFThumb = async (jid, title, text = '', thumbnailUrl, sourceUrl, quoted = m, largerThumbnail = true, adAttribution = true, options = {}) => {
    let msg = {
        contextInfo: {
    ...
    return await sock.sendMessage(jid, { ...msg, ...options }, { quoted });
};
  m.react = async(emoji) => {
