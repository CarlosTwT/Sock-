...
console.log(chalk.green.bold("       ¡Bienvenido al SockBot!       "));
console.log(chalk.blue.bold("====================================="));
console.log(chalk.white.bold("Desarrollador: ") + chalk.cyan.bold("CarlosTwT"));
console.log(chalk.white.bold("Repositorio de GitHub: ") + chalk.cyan.bold("https://github.com/CarlosTwT"));
console.log(chalk.yellow.bold("====================================="));
console.log(chalk.magenta.bold("       Iniciando SockBot...         "));
console.log(chalk.yellow.bold("====================================="));
console.log(chalk.white("Cargando módulos y configuraciones..."));
console.log(chalk.white("Por favor, espera mientras se establece la conexión..."));
console.log(chalk.blue.bold("====================================="));
console.log(chalk.green("¡SockBot está listo para usar! 🎉"));
console.log(chalk.blue.bold("====================================="));
console.log(chalk.white("Comandos disponibles:"));
console.log(chalk.white("1. !help - Mostrar ayuda"));
console.log(chalk.white("2. !clima [ciudad] - Obtener el clima actual"));
console.log(chalk.white("3. !descargar [enlace] - Descargar contenido"));
console.log(chalk.white("4. !ai [pregunta] - Preguntar a la IA"));
console.log(chalk.blue.bold("====================================="));
...
if (!sock.authState.creds.registered) {
     console.log(chalk.white.bold("- Por favor ingrese su número de WhatsApp, por ejemplo +593xxxx"));
   	const phoneNumber = await question(chalk.green.bold(`– tu numero : `));
	      	const code = await sock.requestPairingCode(phoneNumber);
	setTimeout(() => {
    console.log(chalk.white.bold("- Tu código de emparejamiento : " +code))
	}, 3000);
}
//=====[ Connect to WhatsApp ]=======//
